/**
 * @file ArtifactRegistryEngine.ts
 * @description OCI Container Image & Helm Package Registry Manager
 */

export interface IArtifactRegistryEngineConfig {
  instanceId: string;
...
export class ArtifactRegistryEngine {
  private readonly config: IArtifactRegistryEngineConfig;
  private readonly memoryStore: Map<string, any> = new Map();
  private isInitialized: boolean = false;
  private executionCount: number = 0;

  constructor(config?: Partial<IArtifactRegistryEngineConfig>) {
    this.config = {
